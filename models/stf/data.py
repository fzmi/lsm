...
class STFPatchDataset(Dataset):
    """Dataset exposing non-overlapping single-band patches for STF models."""
    ...
    def __init__(
        ...
        for region_name in regions:
            ...
            if h_count == 0 or w_count == 0:
                raise ValueError(
                    f"Image {region_name} ({h}x{w}) is smaller than patch size {patch_size}"
                )
